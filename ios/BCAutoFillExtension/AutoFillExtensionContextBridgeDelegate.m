...
- (NSURL *)sourceURLForBridge:(RCTBridge *)bridge
{
    ...
    // return [NSURL URLWithString:@"http://192.168.1.144:8081/index.bundle?platform=ios&dev=true&minify=false&modulesOnly=false&runModule=true&app=pw.buttercup.shivy"];
